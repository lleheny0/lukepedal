...
[Demo](http://lleheny.github.io)

## Todos:
* Change "bass" to "chords" for a better context for the melody
* Change app title and make favicon
* Add BPM blinker
* Swap play/pause button state
* Add pictures to readme
* Playlist/arrangement functionality?

## Bugs:
### Non-Chrome
* Stuttering and random volume changes (app currently only works well in Chrome)
* Play/pause button moves everything a little
* View buttons have no bottom padding
